...
const HomeScreen = ({ navigation }) => {
    ...
    const [DairyBread, setDairyBread] = useState([]);
    ...
    useEffect(() => {
        setDairyBread(foodData.filter((item) => item.foodType == 'Dairy, Bread'))
        setColdDrinks(foodData.filter((item) => item.foodType == 'Cold Drinks'))
        setNoodles(foodData.filter((item) => item.foodType == 'Noodles'))
    }, [foodData])
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <Cardslider title={"Cold Drinks"} data={ColdDrinks} navigation={navigation} />
                <Cardslider title={"Dairy, Bread"} data={DairyBread} navigation={navigation} />
                <Cardslider title={"Noodels"} data={Noodles} navigation={navigation} />
            </ScrollView>
